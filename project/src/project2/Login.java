...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project2/Images/icons8-search-client-30.png"))); // NOI18N
...
//    -------------------------------------------------- Signing Button Event ----------------------------------------------
    ...
    private void SigningButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SigningButtonActionPerformed
          ...
          try {
            ...
            connect = DriverManager.getConnection("jdbc:mysql://localhost:3306/bank_DB","root","");    // To Connect with datatbase
            ...
            if(rs.next()){                                              // this method rs.next check query is execute or not
                ...
                NewDashboard n=new NewDashboard();
                setVisible(false);
                dispose();                                              // it used to distroy cuurent class from memory
                n.setVisible(true);                    // here we call dashboard class with setVisible method
            }
...
//    -----------------+++++++++++++++================== Color Changing Method When mouse enter and leav ============++++++++++++----------------
    ...
    private void SignupPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SignupPanelMouseClicked
        // TODO add your handling code here:
        usernameAndPass AC = new usernameAndPass();
        setVisible(false);
        dispose();
        AC.setVisible(true);
